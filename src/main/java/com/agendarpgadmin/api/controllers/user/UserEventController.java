...
public class UserEventController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ResponseDTO<EventDTO>> updateEvent(@PathVariable UUID id) {
        return ResponseEntity.status(HttpStatus.GONE).body(
                new ResponseDTO<>(
                        HttpStatus.GONE.value(),
    ...
    public ResponseEntity<ResponseDTO<EventDTO>> registerForEvent(@PathVariable UUID id) {
        return ResponseEntity.status(HttpStatus.GONE).body(
                new ResponseDTO<>(
                        HttpStatus.GONE.value(),
    ...
    public ResponseEntity<ResponseDTO<EventDTO>> unregisterFromEvent(@PathVariable UUID id) {
        return ResponseEntity.status(HttpStatus.GONE).body(
                new ResponseDTO<>(
                        HttpStatus.GONE.value(),
