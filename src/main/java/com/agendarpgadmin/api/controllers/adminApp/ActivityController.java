...
import com.agendarpgadmin.api.services.AdminApp.ActivityService;
...
public class ActivityController {
    ...
    public ResponseEntity<ResponseDTO<List<ActivityDTO>>> getActivitiesByEvent(@PathVariable Long eventId) {
        try {
    ...
    public ResponseEntity<ResponseDTO<ActivityDTO>> getActivityById(@PathVariable Long id) {
        try {
